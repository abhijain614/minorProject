...
public class SplashFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("A Smarter way to track fiiles");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            System.out.println(config.ConfigExists());
            if(config.ConfigExists()){
                ...
                this.setVisible(false);
                ServerConfigFrame configClass=new ServerConfigFrame();
                configClass.setVisible(true); 
            }            
